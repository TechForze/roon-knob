...
# Step 3: Copy binary
echo "[3/4] Copying binary to firmware directory..."
...
echo "Files updated:"
echo "  - $CMAKE_FILE"
echo "  - $FIRMWARE_DIR/roon_knob.bin"
echo "  - $VERSION_JSON"
echo ""
echo "Next steps:"
echo "  1. git add -A && git commit -m 'Release firmware v$NEW_VERSION'"
echo "  2. git push"
echo "  3. Rebuild Docker image: cd roon-extension && docker build -t muness/roon-extension-knob:latest ."
echo "  4. docker push muness/roon-extension-knob:latest"
